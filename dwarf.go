/*
This file is based on a copy of https://github.com/christophberger/goman/blob/master/dwarf.go.
*/
...
//
// NOTE: this file was modified by @r-medina to exclude version info
